...
namespace ModuleFramework.Libs.WebSocketLib.Net
{
    ...
    public sealed class Cookie
    {
        ...
        public string Port
        {
            ...
            set
            {
                ...
                if (!tryCreatePorts(value, out _ports, out err))
                    throw new CookieException(
                        $"The value specified for the Port attribute contains an invalid value: {err}");
        ...
        {
            return hash(StringComparer.InvariantCultureIgnoreCase.GetHashCode(_name),_value.GetHashCode(),
                _path.GetHashCode(),StringComparer.InvariantCultureIgnoreCase.GetHashCode(_domain),_version);
        }
