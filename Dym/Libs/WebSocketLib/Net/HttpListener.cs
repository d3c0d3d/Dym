...
namespace Dym.Libs.WebSocketLib.Net
{
    ...
    public sealed class HttpListener : IDisposable
    {
        ...
        public bool AddConnection(HttpConnection connection)
        {
            if (!_listening)
                return false;
        ...
        public HttpListenerAsyncResult BeginGetContext(HttpListenerAsyncResult asyncResult)
        {
            lock (_ctxRegistrySync)
            {
                if (!_listening)
        ...
        public Func<IIdentity, NetworkCredential> GetUserCredentialsFinder()
        {
            return _userCredFinder;
        }
        ...
        public AuthenticationSchemes SelectAuthenticationScheme(HttpListenerRequest request)
        {
