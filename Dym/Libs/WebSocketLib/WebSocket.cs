...
namespace ModuleFramework.Libs.WebSocketLib
{
    ...
    public class WebSocket : IDisposable
    {
        ...
        // As server
        public Func<WebSocketContext, string> CustomHandshakeRequestChecker { get; set; }
        ...
        /// <summary>
        /// Enabled infinity reconnect to <see cref="Connect"/>
        /// </summary>
        public bool InfinityReconnect { get; set; }
        ...
        private bool connect()
        {
            ...
            lock (_forState)
            {
                ...
                if (_retryCountForConnect > _maxRetryCountForConnect && !InfinityReconnect)
                {
